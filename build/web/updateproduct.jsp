                    ...
                    <div class="col-md-12">
                        <div class="form_container">
                            <form action="promng" method="post">
                                ...
                                <input type="text" name="menuId" value="${menu.menuId}" class="min_width_400px" readonly><br>
                                <label class="min_width_140px">Product's name:</label>
                                <input type="text" name="menuName" value="${menu.menuName}" class="min_width_400px"
                                       required><br>
                                <label class="min_width_140px">Type of food:</label>
                                <input type="text" name="typeOfFood" value="${menu.typeOfFood}" class="min_width_400px"
                                       required><br>
                                <label class="min_width_140px">Quantity:</label>
                                <input type="text" name="quantity" value="${menu.quantity}" class="min_width_400px"
                                       required><br>
                                <label class="min_width_140px">Price:</label>
                                <input type="text" name="price" value="${menu.price}" class="min_width_400px"
                                       required><br>
                                <label class="min_width_140px">Picture:</label>
                                <input type="text" name="picture" value="${menu.picture}" class="min_width_400px" 
                                       required><br>
                                <label class="min_width_140px">Detail:</label>
                                <input type="text" name="detail" value="${menu.detail}" class="min_width_400px" 
                                       required><br>
