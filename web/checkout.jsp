                        ...
                        <section class="book_section layout_padding">
                            ...
                            <div class="container">
                                <div class="heading_container">
                                    ...
                                    <p>
                                        Please check your email to get the booking code!<br>
                                        Please show your code to get order!                                        
                                    </p>       
                                </div>
                                <p>See you soon!</p>
                                <a class="navbar-brand" href="<%=request.getContextPath()%>/home" style="font-size: 3rem">Continue</a>
                            </div>
                        </section>
                        <!-- end book section -->
